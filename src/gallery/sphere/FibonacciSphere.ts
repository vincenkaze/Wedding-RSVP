...
export const SELECTED_INDICES: readonly number[] = [
  4, 12, 18, 26, 35, 42, 49, 56, 63, 70, 78, 85, 92, 99, 106, 113, 119,
] as const
...
export function getSelectedAnchors(anchors: Anchor[]): Anchor[] {
  return SELECTED_INDICES.map((i) => anchors[i]).filter(Boolean)
}
