...
export default function FloatingPhoto({
  ...
  const gyroX = gyroRoll * depth * 40
  const gyroY = gyroPitch * depth * 40
  ...
  return (
    ...
    >
      {/* Gyro parallax layer — separate from gesture layer */}
      <div
        style={{
          transform: `translate3d(${gyroX}px, ${gyroY}px, ${depth * 30}px)`,
