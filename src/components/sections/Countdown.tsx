...
import { wedding, sections, hero } from '../../content/content'
    ...
    <Section className="bg-white pt-20 pb-24 sm:pt-28 sm:pb-32">
      <div className="mx-auto max-w-3xl px-6 text-center">
        <motion.p
          ...
          className="font-display text-xs font-semibold uppercase tracking-[0.24em] text-gold"
        >
        ...
        <motion.p
          ...
          className="mt-3 font-display text-3xl tracking-wide text-ink sm:text-4xl"
        >
          {hero.countdownLabel}
        </motion.p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:flex-nowrap">
          {units.map((unit, i) => (
            <motion.div
              ...
              className="flex w-20 flex-col items-center rounded-2xl bg-cream px-3 py-5 shadow-sm ring-1 ring-black/5 sm:w-28 sm:px-4 sm:py-7 md:w-32"
            >
